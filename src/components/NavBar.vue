<template>
  <div class="w-100 sticky-top navbar">
    <div class="navbar-container container w-100">
      <div class="row justify-content-between w-100">
        <div class="col-lg-9 w-100">
          <nav class="d-flex w-100">
            <h1 class="logo">
              MOVIEFINDER<span style="color: #ff0000"
                >Z<span style="color: #d10404">Z</span></span
              ><span style="color: #b60000">Z</span>
            </h1>
            <div
              class="w-50 navbar-items d-flex justify-content-start align-items-center"
            >
...
export default {
  ...
  watch: {
    "filters.title": async function (value) {
      this.searchWithFilter(value);
    },
  },
};
</script>
